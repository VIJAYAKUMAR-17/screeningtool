...
| F7 | Tier 2 batch toast claimed success even when rows failed (stale state read) | Per-row outcomes returned and counted (`frontend/src/features/screening/ScreeningPage.tsx`) |
